/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/siteimport/trunk/siteimport-webapp/webapp/src/java/org/etudes/siteimport/webapp/XMLHelper.java $
 * $Id: XMLHelper.java 7333 2014-01-30 19:43:58Z mallikamt $
 ***********************************************************************************
 *
...
public class XMLHelper
{
	...
	/**
	 * Creates xml document and adds element
	 * 
	 * @param element
	 */
	...
	static public void generateXMLFile(String url, Document document) throws Exception
	{
		...
		try
		{
			if (document == null) document = DocumentHelper.createDocument();
	 ...
	 */
	static public Document parseFile(File xmlFile)
	{
		try
		{
